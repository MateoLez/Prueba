                        ...
                        <form role="form" method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group{{ $errors->has('lastname') ? ' has-danger' : '' }}">
                                <div class="input-group input-group-alternative mb-3">
                                    ...
                                    <input class="form-control{{ $errors->has('lastname') ? ' is-invalid' : '' }}" placeholder="{{ __('Apellidos') }}" type="text" name="lastname" value="{{ old('lastname') }}" required autofocus>
                                </div>
                            ...
                            {{-- Empresa --}}
                                <div class="input-group input-group-alternative mb-3">
                                    <div class="input-group-prepend">
                                        ...
                                        <select class="form-control" name="business" value="{{ old('business') }}" required>
                                            <option value="0" selected disabled>--Seleccione su Empresa--</option>
                                            <option value="Mono-App" {{ old('business') == 'Mono-App' ? 'selected' : '' }}>Mono-App</option>
                                            <option value="Distribuidora-HB" {{ old('business') == 'Distribuidora-HB' ? 'selected' : '' }}>Distribuidora-HB</option>
                                        </select>
                                </div>
                            ...
                            <div class="form-group">
                                <div class="input-group input-group-alternative">
                                    ...
                                    <input class="form-control" placeholder="{{ __('Confirme Contraseña') }}" type="password" name="password_confirmation" required>
                                </div>
                            </div>
